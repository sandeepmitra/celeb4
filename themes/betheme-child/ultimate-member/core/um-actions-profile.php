				...
				<div class="um-profile-meta">
					...
					<div class="um-main-meta">
						...
						<div class="um-name">
							...
							<a style="font-size:16px; href="<?php echo um_user_profile_url(); ?>" title="<?php echo um_user('celeb-category'); ?>"><?php echo um_user('celeb-category'); ?></a> ,&nbsp;&nbsp;
							...
							<a style="font-size:16px; href="<?php echo um_user_profile_url(); ?>" title="<?php echo um_user('livein'); ?>"><?php echo um_user('livein'); ?></a>
