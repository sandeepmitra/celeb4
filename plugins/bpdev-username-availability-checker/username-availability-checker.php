...
class BuddyDev_Username_Availability_Checker {
	...
	public function load_js() {
		...
		if( $this->should_load_asset() ) {
			...
			$data = array( 
				'selectors' => apply_filters( 'buddydev_uachecker_selectors', 'input#user_login-187, input#signup_username, form#createuser input#user_login, #registerform input#user_login' ) 
			);
